export interface AgreementText {
  ...
  signatureFields: {
    ...
    onBehalfOf?: boolean;
    q1_armsIndustry?: boolean;
    q2_sanctionedPartners?: boolean;
    q3_hasSupplierCode?: boolean;
    policyNotes?: boolean;
    // Supplier Self-Declaration specific fields
    companyName?: boolean;
    businessAddress?: boolean;
    contactPersonTitle?: boolean;
    emailPhone?: boolean;
...
Please complete the signature information in the form below.`,
    signatureFields: {
      ...
      q1_armsIndustry: true,
      q2_sanctionedPartners: true,
      q3_hasSupplierCode: true,
      policyNotes: true,
    },
  },
